...
class Contact(BaseBitrixObject):
    """
    The Contact class provides static methods for formatting Bitrix24 contact field parameters.
    Each method corresponds to a field in the ContactField class and returns a string representation
    suitable for use in Bitrix24 API requests.
    """
    ...
    @staticmethod
    def SET_BIRTHDATE(value: str) -> dict[str, str]:
        return {CONTACT_FIELD.BIRTHDATE: str(value)}
    ...
    @staticmethod
    def SET_UTM_SOURCE(value: str) -> dict[str, str]:
        return {CONTACT_FIELD.UTM_SOURCE: int(value)}
